...
item replace block ~ ~ ~ container.22 with minecraft:black_stained_glass_pane{display: {Name: '""'}, invibg: 1b}
item replace block ~ ~ ~ container.24 with minecraft:black_stained_glass_pane{display: {Name: '""'}, invibg: 1b}
...
# 切换
item replace block ~ ~ ~ container.26 with minecraft:purple_stained_glass_pane{display: {Name: '{"text":"切换至末影箱/背包","italic": false,"color": "aqua","bold": true}'}, invibg: 1b}
