...
execute if score #return inviCreate matches 1 run setblock ~-1 ~ ~ minecraft:chest[facing=north,type=right]
execute if score #return inviCreate matches 1 run setblock ~ ~ ~ minecraft:chest[facing=north,type=left]
...
execute if score #return inviCreate matches 2 run setblock ~1 ~ ~ minecraft:chest[facing=north,type=left]
execute if score #return inviCreate matches 2 run setblock ~ ~ ~ minecraft:chest[facing=north,type=right]
...
execute if score #return inviCreate matches 3 run setblock ~ ~ ~-1 minecraft:chest[facing=east,type=right]
execute if score #return inviCreate matches 3 run setblock ~ ~ ~ minecraft:chest[facing=east,type=left]
...
execute if score #return inviCreate matches 4 run setblock ~ ~ ~1 minecraft:chest[facing=east,type=left]
execute if score #return inviCreate matches 4 run setblock ~ ~ ~ minecraft:chest[facing=east,type=right]